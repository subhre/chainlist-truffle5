...
contract('ChainList', function(accounts) {
    ...
    const articleName2 = "artile 2";
    const articleDescription2 = "Description for article 2";
    const articlePrice2 = web3.utils.toBN(20);
    let sellerBalanceBeforeBuy, sellerBalaneAfterBuy;
    let buyerBalanceBeforeBuy, buerBalanceAfterBuy;
    ...
    it("should let us sell a first article", async () => {
        const receipt = await chainListInstance.sellArticle(articleName1, articleDescription1,
    ...
    it("should let us buy the first article", async () => {            
        ...
        assert.equal(articlesForSale[0].toNumber(), 2, "article2 should be the only article left for sale");
